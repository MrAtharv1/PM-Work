    ...
    (
      ...
      >
        <svg viewBox="0 0 100 100" width="32" height="32">
          ...
          <path d="M 50,85 C 40,85 42,60 50,52 C 58,60 60,85 50,85" fill="#09090b" />
          <path d="M 50,54 C 46,45 46,38 50,35 C 54,38 54,45 50,54" fill="#09090b" />
          <circle cx="50" cy="27" r="1.5" fill="#09090b" />
          <circle cx="44" cy="29" r="1.5" fill="#09090b" />
          <circle cx="56" cy="29" r="1.5" fill="#09090b" />
        </svg>
      </div>
    ),
    { ...size }
